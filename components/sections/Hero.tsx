      ...
      <div className="container-main relative z-10 py-32 text-center">
        ...
        >
          ...
          <motion.h1
            ...
            className="font-display text-5xl sm:text-6xl md:text-7xl font-light leading-[1.05] tracking-[-2px] mb-7"
          >
          ...
          >
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 px-10 py-4 bg-accent text-black font-body font-bold rounded-xl hover:bg-accent-dark transition-colors text-base"
            >
            ...
            <a
              href="#projetos"
              className="inline-flex items-center justify-center gap-2 px-10 py-4 text-ink-muted border border-white/[0.12] rounded-xl hover:bg-white/[0.04] transition-colors text-base"
            >
              Ver projetos ↓
            </a>
          </motion.div>
